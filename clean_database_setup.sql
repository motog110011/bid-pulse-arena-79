-- Clean database setup that handles existing objects properly
-- Run this in your Supabase SQL Editor

-- 1. Create tables (these will be skipped if they exist)
...
-- 2. Enable RLS (these will be ignored if already enabled)
...
-- 3. Drop existing policies first, then recreate them
...
SELECT 'Setup completed successfully! You should see user data below:' as status;
