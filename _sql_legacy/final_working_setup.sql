-- Final working solution with correct data types
...
-- 5. Create the function with correct data types that match the database
...
-- 9. Success message
SELECT 'SUCCESS! Your admin panel should now work. Make yourself admin with:
