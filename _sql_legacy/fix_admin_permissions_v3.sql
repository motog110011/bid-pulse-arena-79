...
-- Sin IF NOT EXISTS para políticas
...
-- 4. Eliminar política restrictiva si existe y crear una permisiva
...
-- 5. Crear política permisiva para pruebas
CREATE POLICY "Allow all for testing" ON public.scheduled_auctions FOR ALL USING (true);

-- 6. Crear función simplificada SIN verificación de admin
...
-- 7. Crear función para obtener próximas subastas sin restricciones
...
-- 8. Otorgar todos los permisos necesarios
...
-- 11. Probar función de consulta
SELECT 'Probando función de consulta...' as step;
SELECT * FROM public.get_upcoming_scheduled_auctions_simple(5);

SELECT '🎉 ¡Todo configurado correctamente! Ahora prueba desde el panel React.' as final_message;
