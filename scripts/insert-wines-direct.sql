-- =====================================================
-- INSERTAR 26 PRODUCTOS DE VINOS DIRECTAMENTE
-- Usar en Supabase SQL Editor con permisos de administrador
-- =====================================================

-- Temporalmente deshabilitar RLS para inserción
SET row_security = off;

-- Insertar 26 botellas de vino directamente en auctions
...
-- Restaurar configuración de RLS
SET row_security = on;
